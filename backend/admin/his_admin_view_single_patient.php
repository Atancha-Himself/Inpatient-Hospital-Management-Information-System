                        ...
                        <div class="col-lg-4 col-xl-4">
                            <div class="card-box text-center">
                                ...
                                <div class="text-left mt-3">
                                    ...
                                    <p class="text-muted mb-2 font-13"><strong>Bed ID :</strong> <span class="ml-2"><?php echo $row->bed_id ? $row->bed_id : 'Not Assigned';?></span></p> <!-- Added Bed ID -->
                                    <hr>
                                        ...
                                        <ul class="list-unstyled timeline-sm">
                                            ...
                                            ?>
                                                <li class="timeline-sm-item">
                                                    ...
                                                    <p class="text-muted mt-2"><?php echo $row->lab_pat_tests;?></p>
                                                    <hr>
                                                    <h5>Laboratory Results</h5>
                                                    <p class="text-muted mt-2"><?php echo $row->lab_pat_results;?></p>
                                                    <hr>
                                                </li>
                                            <?php } ?>
                                        </ul>
