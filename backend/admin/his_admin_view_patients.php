                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <tr>
                                            ...
                                            <th data-hide="phone">Bed ID</th> <!-- Added Bed ID column -->
                                            <th data-hide="phone">Action</th>
                                        </tr>
                                        </thead>
                                        <?php
                                        /*
                                         * Get details of all patients with their bed assignments
                                         */
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row->bed_id ? $row->bed_id : 'Not Assigned';?></td> <!-- Display Bed ID or 'Not Assigned' -->
