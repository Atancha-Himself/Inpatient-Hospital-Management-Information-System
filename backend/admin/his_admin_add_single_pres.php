...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_presc']))
		{
			...
			$query="INSERT INTO  his_prescriptions  (pres_pat_name, pres_pat_number, pres_pat_addr, pres_pat_age, pres_number, pres_pat_ailment, pres_ins) VALUES(?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssss', $pres_pat_name, $pres_pat_number, $pres_pat_addr, $pres_pat_age, $pres_number, $pres_pat_ailment, $pres_ins);
			$stmt->execute();
			/*
