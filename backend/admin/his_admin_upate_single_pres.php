...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient_presc']))
		{
			...
			$query="UPDATE   his_prescriptions  SET pres_pat_name = ?, pres_pat_addr = ?, pres_pat_age = ?, pres_pat_ailment = ?, pres_ins = ? WHERE pres_number = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $pres_pat_name, $pres_pat_addr, $pres_pat_age,  $pres_pat_ailment, $pres_ins, $pres_number);
			$stmt->execute();
			/*
