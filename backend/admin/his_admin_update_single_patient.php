...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient']))
		{
			...
			$query="UPDATE  his_patients  SET pat_fname=?, pat_lname=?, pat_age=?, pat_dob=?, pat_number=?, pat_phone=?, pat_addr=?, pat_ailment=? WHERE pat_id = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssssi', $pat_fname, $pat_lname, $pat_age, $pat_dob, $pat_number, $pat_phone, $pat_addr, $pat_ailment, $pat_id);
			$stmt->execute();
			/*
